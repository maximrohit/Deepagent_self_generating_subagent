...
Sub-agent creation pipeline (functional stages):
  ...
  2. generate_sub_agent_code
       Write (or revise) ONLY the missing-component .py module.
  3. validate_contract
...
def create_sub_agent_with_critic_loop(
    ...
    *,
    ...
    """
    Full creation pipeline with reuse analysis + self-correction.
    ...
    for iteration in range(1, max_iters + 1):
        ...
        code = generate_sub_agent_code(
            spec, critique_feedback=critique, iteration=iteration
        )
